        ...
        <div className="h-full px-3 py-4 flex flex-col">
          ...
          <div className="mt-5 h-full max-h-flex-grow flex-grow overflow-y-auto overflow-x-hidden">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-0  rounded-full px-4"> <MessageSquareCodeIcon size="16" /> <SidebarButton to="/" text="Get Started" className="text-gray-400 m-0 px-2" /></div>
